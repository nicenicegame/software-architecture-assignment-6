...
//
function sendViewedMessage(messageChannel, payload) {
    console.log(`Publishing message on "viewed" exchange.`);
        
    const msg = { videoPath: payload.videoPath, videoId: payload.videoId };
...
function setupHandlers(app, messageChannel) {
    app.get("/video", (req, res) => { // Route for streaming video.
        ...
        const videoPath = id === 2 ? "./videos/roblox.mp4" : "./videos/SampleVideo_1280x720_1mb.mp4";
        fs.stat(videoPath, (err, stats) => {
            ...
            sendViewedMessage(messageChannel, { videoPath, videoId: id }); // Send message to "history" microservice that this video has been "viewed".
        });
    });
}
